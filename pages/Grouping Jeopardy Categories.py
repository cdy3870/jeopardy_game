...
st.set_page_config(page_title="Grouping Jeopardy Categories")
...
st.write("We can do this with zero-shot classification. This technique is used to predict labels that have not been seen before for each sample. HuggingFace has a pre-trained zero-shot classifier with a BART transformer.")
